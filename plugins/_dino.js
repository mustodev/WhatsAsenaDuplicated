...
const Lang = Language.getString('_dino');

if (Config.WORKTYPE == 'private') {

    Asena.addCommand({pattern: 'dino ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'dino ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
